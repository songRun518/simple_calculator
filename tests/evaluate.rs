...
fn test_basic_addition() {
    ...
    assert_eq!(calc.calculate().unwrap(), 3.0);
}

#[test]
fn test_basic_subtraction() {
    let mut calc = Calculator::new("5 - 3".to_string());
    assert_eq!(calc.calculate().unwrap(), 2.0);
}

#[test]
fn test_basic_multiplication() {
    let mut calc = Calculator::new("2 * 3".to_string());
    assert_eq!(calc.calculate().unwrap(), 6.0);
}
...
fn test_basic_modulo() {
    ...
    assert_eq!(calc.calculate().unwrap(), 1.0);
}

#[test]
fn test_operator_precedence() {
    let mut calc = Calculator::new("2 + 3 * 4".to_string());
    assert_eq!(calc.calculate().unwrap(), 14.0);
}

#[test]
fn test_parentheses() {
    let mut calc = Calculator::new("(2 + 3) * 4".to_string());
    assert_eq!(calc.calculate().unwrap(), 20.0);
}

#[test]
fn test_nested_parentheses() {
    let mut calc = Calculator::new("(2 + (3 * 2)) * 4".to_string());
    assert_eq!(calc.calculate().unwrap(), 32.0);
}
...
fn test_decimal_numbers() {
    ...
    assert_eq!(calc.calculate().unwrap(), 4.0);
}

#[test]
fn test_complex_expression() {
    let mut calc = Calculator::new("(3 + 5) * 2 - 8 / 4 + 10 % 3".to_string());
    assert_eq!(calc.calculate().unwrap(), 15.0);
}
